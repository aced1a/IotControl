...
fun NumberPicker(
    ...
    Column(
        ...
        Icon(Icons.Filled.KeyboardArrowUp, contentDescription = "arrow", tint = arrowColor)
//        Arrow(direction = ArrowDirection.UP, tint = arrowColor)
        ...
        Icon(Icons.Filled.KeyboardArrowDown, contentDescription = "arrow", tint = arrowColor)
